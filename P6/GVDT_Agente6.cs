...
public class GVDT_Agente6 : ISSR_Agent
{
    ...
    ISSRState SF_GoingToGripBigStone()
    {
        ...
        switch (current_event)
        {
            ...
            case ISSREventType.onEnterSensingArea:
                ...
                if (focus_object.Equals(object_just_seen))
                    next_state = GetBStone(focus_object);
                break;
    ...
    ISSRState SF_WaitforNoStonesMovingBigStone()
    {
        ...
        switch (current_event)
        {
            ...
            case ISSREventType.onMsgArrived:
                ...
                if ((user_msg_code == (int)GVDT_MsgCode.LetsGoToGoal && msg_obj.Equals(focus_object)))
                {
        ...
        switch (current_event)
        {
            case ISSREventType.onTickElapsed:
                ...
                if (focus_object != null)//si hay alguna piedra  
                {
                    ...
                    else next_state = GetBStone(focus_object);
                }
                else//Si focus_object es null significa que no hay más piedras disponibles -- ¿Nos ponemos a molestar al equipo contrario?
                {
                ...
                break;
            case ISSREventType.onEnterSensingArea:
                //onEnterSensingArea(object_just_seen);
                break;
            default:
    ...
    */
    ...
    {
        if (user_msg_code == (int)GVDT_MsgCode.LetsGoToGoal)
        {
